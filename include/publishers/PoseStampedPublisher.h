 ...
 *
*/
class PoseStampedPublisher : public SBP2ROS2Publisher<geometry_msgs::msg::PoseStamped,
                                                    sbp_msg_pos_ecef_t,
 ...
 public:
   ...
   * @param topic_name Name of the topic to publish a geometry_msgs::msg::PoseStamped message
 ...
 protected:
  /**
   * @brief Checks that the Ros2 eometry_msgs::msg::PoseStamped is complete, if so,
   * it publishes it
   *
   */
